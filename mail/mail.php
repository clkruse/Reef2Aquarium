...
$recipientEmail             = 'caleb.krs@gmail.com'; // REQUIRED value.
$recipientName              = 'Reef to Aquarium';             // REQUIRED value.
...
$timeZone					= 'America/Los_Angeles';         // OPTIONAL, but some servers require this to be set.
